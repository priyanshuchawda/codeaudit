...
| Unauthenticated hosted access    | A public HTTP MCP endpoint could allow unintended repository inspection.                                                          | Hosted HTTP deployments can require API-key/Bearer auth and should run behind HTTPS with narrow CORS.      |
